...
export default async function run() {
  ...
  try {
    ...
    const changelog = isGithubRelease
      ? await git.getChangelog({ changelogCommand, tagName: src.tagName, latestVersion })
      : null;
    ...
    if ((await git.isWorkingDirClean()) && options.requireCleanWorkingDir) {
