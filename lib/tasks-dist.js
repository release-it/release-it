...
const getDistRepoClients = async ({ options, log, isDryRun, changelogs, shell, remoteUrl }) => {
  ...
  const ghClient = new GitHub(...ghDistClientOptions, { isDryRun, log, changelogs, remoteUrl });
  const glClient = new GitLab(...glDistClientOptions, { isDryRun, log, changelogs, remoteUrl });
