...
class Spinner {
  constructor({ global = {}, container = {} } = {}) {
    this.isSpinnerDisabled = global.isInteractive || global.isVerbose || global.isDryRun || global.isDebug;
    this.canForce = global.isInteractive && !global.isVerbose && !global.isDryRun && !global.isDebug;
