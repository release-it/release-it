...
const t = {
  ...
  isPreRelease: preReleaseTypes,
  default: [...releaseTypes, ...preReleaseTypes]
};

const getIncrementChoices = context => {
  const types = context.latestIsPreRelease ? t.latestIsPreRelease : context.isPreRelease ? t.isPreRelease : t.default;
...
class Prompt {
  constructor({ config, inquirer = inq }) {
